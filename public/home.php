...
<body >
  ...
  <div class="relative">
  <!-- Your image with low opacity -->
  <img src="../img/Home.jpg" alt="Your Image" class="w-full " style="opacity: 0.25; border-bottom-color: grey-600; border-bottom-width: 10px;">
  ...
  <div class="absolute inset-0 flex items-center justify-center">
    ...
    <div class="items-center justify-center">
      ...
      <h1 class="text-black text-2xl ">Unleash the Road Ahead</h1>
      
      <h1 class="text-black text-6xl font-bold ">Your Journey Begins!</h1>
    </div>
  </div>
</div>
...
<?php
          foreach ($cars as $car) {
            ...
            $year=$car["3"];
            $price=$car["4"];
            $registeration_date=$car["5"];
            $office_id=$car["6"];
            $car_photos=$customer->getCarPhotos($plate_id);
            // var_dump($car_photos);
            // $file_name = $user->getprofilePicture($user_id);
            // $data = $user->getPostUserName($user_id);
  ...
  <div class="p-6">
    ...
    <div class="inline-flex flex-wrap items-center gap-3 mt-8 group">
      <div
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#050505" d="M135.2 117.4L109.1 192H402.9l-26.1-74.6C372.3 104.6 360.2 96 346.6 96H165.4c-13.6 0-25.7 8.6-30.2 21.4zM39.6 196.8L74.8 96.3C88.3 57.8 124.6 32 165.4 32H346.6c40.8 0 77.1 25.8 90.6 64.3l35.2 100.5c23.2 9.6 39.6 32.5 39.6 59.2V400v48c0 17.7-14.3 32-32 32H448c-17.7 0-32-14.3-32-32V400H96v48c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32V400 256c0-26.7 16.4-49.6 39.6-59.2zM128 288a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm288 32a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg>
        <h6><?=$make?></h6>
      </div>
      <span
        class="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M345 39.1L472.8 168.4c52.4 53 52.4 138.2 0 191.2L360.8 472.9c-9.3 9.4-24.5 9.5-33.9 .2s-9.5-24.5-.2-33.9L438.6 325.9c33.9-34.3 33.9-89.4 0-123.7L310.9 72.9c-9.3-9.4-9.2-24.6 .2-33.9s24.6-9.2 33.9 .2zM0 229.5V80C0 53.5 21.5 32 48 32H197.5c17 0 33.3 6.7 45.3 18.7l168 168c25 25 25 65.5 0 90.5L277.3 442.7c-25 25-65.5 25-90.5 0l-168-168C6.7 262.7 0 246.5 0 229.5zM144 144a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z"/></svg>
        <h6><?=$model?></h6>
      </span>
      <span
        class="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
